...
public class StateManager {
    ...
    // Need guessing state.
    public static final int STATE_MATCH_UP = 1;
...
//                Toast.makeText(mActivity.getBaseContext(), "Sending turn: "
//                        + mActivity.mTurnData.artistTurn.turnNumber, Toast.LENGTH_SHORT).show();
